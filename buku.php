...
<h1 style="color:white; margin-top: 20px; margin-left: 20px; padding:20px">Semua pilihan mu ada di sini <img src="img/tangan.png" width="50px">Produk Buku</h1>
...
$gk = mysqli_query($link, "SELECT * FROM produk WHERE jenis='buku' ORDER BY id_produk DESC");
